...
public abstract class Choice6<A, B, C, D, E, F> implements
    ...
    public <G, App extends Applicative<?, App>, TravB extends Traversable<G, Choice6<A, B, C, D, E, ?>>,
        ...
        return match(a -> pure.apply((TravB) Choice6.<A, B, C, D, E, G>a(a)),
                     b -> pure.apply((TravB) Choice6.<A, B, C, D, E, G>b(b)),
                     ...
                     f -> fn.apply(f).<Choice6<A, B, C, D, E, G>>fmap(Choice6::f).<TravB>fmap(Applicative::coerce).coerce());
    }
