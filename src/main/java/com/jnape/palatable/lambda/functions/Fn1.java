 ...
 */
@FunctionalInterface
public interface Fn1<A, B> extends Monad<B, Fn1<A, ?>>, Cartesian<A, B, Fn1>, Cocartesian<A, B, Fn1>, Function<A, B> {
    ...
    @Override
    default <Z> Fn1<Choice2<Z, A>, Choice2<Z, B>> costrengthen() {
        return za -> za.fmap(this);
    }
