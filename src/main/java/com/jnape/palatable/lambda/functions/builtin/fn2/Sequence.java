...
public final class Sequence<A, App extends Applicative<?, App>, Trav extends Traversable<?, Trav>,
    ...
    public static <A, App extends Applicative<?, App>, AppA extends Applicative<A, App>,
            ...
            IterableApp extends Iterable<AppA>> Fn1<Function<Iterable<A>, ? extends AppIterable>, AppIterable> sequence(
            IterableApp iterableApp) {
        return pure -> (AppIterable) Sequence.<A, App, LambdaIterable<?>, LambdaIterable<A>, AppA,
                Applicative<LambdaIterable<A>, App>, LambdaIterable<AppA>>sequence(
    ...
    Fn1<Function<Map<A, B>, ? extends AppMap>, AppMap> sequence(MapApp mapApp) {
        return pure -> (AppMap) Sequence.<B, App, LambdaMap<A, ?>, LambdaMap<A, B>, AppB,
                Applicative<LambdaMap<A, B>, App>, LambdaMap<A, AppB>>sequence(
