...
public class BifunctorLaws<BF extends Bifunctor> implements Trait<Bifunctor<?, ?, BF, BF>> {

    @Override
    public void test(Bifunctor<?, ?, BF, BF> bifunctor) {
        Present.<String>present((x, y) -> x + "\n\t - " + y)
                .<Function<Bifunctor<?, ?, BF, BF>, Maybe<String>>>foldMap(
                        f -> f.apply(bifunctor),
